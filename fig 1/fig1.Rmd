...
#https://egg2.wustl.edu/roadmap/web_portal/imputed.html#chr_imp
	...
	bedtools random -n 24476 -l 1000 -g /home/pubudu/projects/rrg-hsn/utilities/fetchchrmsizes/hg38.chrom.sizes -seed 1600 | awk -v OFS="\t" '{print $1,$2,$3,"region"NR}' > random_regions_hg38_for_chromHMM_comparison.bed

	bedtools random -n 24476 -l 1000 -g /home/pubudu/projects/rrg-hsn/utilities/fetchchrmsizes/hg38.chrom.sizes -seed 1700 | awk -v OFS="\t" '{print $1,$2,$3,"region"NR}' > random_regions_hg38_for_chromHMM_comparison_seed1700.bed

	bedtools random -n 24476 -l 400 -g /home/pubudu/projects/rrg-hsn/utilities/fetchchrmsizes/hg19.chrom.sizes -seed 1600 | awk -v OFS="\t" '{print $1,$2,$3,"region"NR}' > random_regions_hg19_for_chromHMM_comparison.bed

	###tumor
	bedtools random -n 22253 -l 400 -g /home/pubudu/projects/rrg-hsn/utilities/fetchchrmsizes/hg38.chrom.sizes -seed 1700 | awk -v OFS="\t" '{print $1,$2,$3,"region"NR}' > random_regions_hg38_for_chromHMM_comparison_seed1700_for_T_enh.bed

	bedtools random -n 22253 -l 400 -g /home/pubudu/projects/rrg-hsn/utilities/fetchchrmsizes/hg38.chrom.sizes -seed 1600 | awk -v OFS="\t" '{print $1,$2,$3,"region"NR}' > random_regions_hg38_for_chromHMM_comparison_seed1600_for_T_enh.bed

	###normal
	bedtools random -n 10536 -l 400 -g /home/pubudu/projects/rrg-hsn/utilities/fetchchrmsizes/hg38.chrom.sizes -seed 1700 | awk -v OFS="\t" '{print $1,$2,$3,"region"NR}' > random_regions_hg38_for_chromHMM_comparison_seed1700_for_N_enh.bed

	bedtools random -n 10536 -l 400 -g /home/pubudu/projects/rrg-hsn/utilities/fetchchrmsizes/hg38.chrom.sizes -seed 1600 | awk -v OFS="\t" '{print $1,$2,$3,"region"NR}' > random_regions_hg38_for_chromHMM_comparison_seed1600_for_N_enh.bed
...
```{bash}
	...
	#50 pcnt
	awk -v OFS="\t" '{print $1,$2,$3,$4}' GenoSTAN_enhancers.bed | bedtools intersect -a cat_N_and_T_H3K27ac_and_H3K4me1_all_samples_with_id_extended.grc38_remove_gene_body_and_10kb_extension_normalized_10kb.bed -b stdin -wao -f 0.5 | awk -v OFS="\t" '{if($7!=-1){print $0}}' > genostand_enh_overlap_with_all_enh_50pcnt_overlap_extended_normalized.bed

	awk -v OFS="\t" '{print $1,$2,$3,$4}' GenoSTAN_enhancers.bed | bedtools intersect -a random_regions_hg38_for_chromHMM_comparison.bed -b stdin -wao -f 0.5 | awk -v OFS="\t" '{if($7!=-1){print $0}}' > genostand_enh_overlap_with_random_regions_hg38_50pcnt_overlap_extended_normalized.bed

	awk -v OFS="\t" '{print $1,$2,$3,$4}' GenoSTAN_enhancers.bed | bedtools intersect -a random_regions_hg38_for_chromHMM_comparison_seed1700.bed -b stdin -wao -f 0.5 | awk -v OFS="\t" '{if($7!=-1){print $0}}' > genostand_enh_overlap_with_random_regions_hg38_50pcnt_overlap_extended_normalized_seed1700..bed


	awk -v OFS="\t" '{print $1,$2,$3,$4}' GenoSTAN_enhancers.bed | bedtools intersect -a enhancers_from_cancer_discovery_paper.grc38_normalized.bed -b stdin -wao -f 0.5 | awk -v OFS="\t" '{if($7!=-1){print $0}}' | awk -v OFS="\t" '{print $1,$2,$3,$4,$6,$7,$8,$9,$10}' > genostand_enh_overlap_with_all_enh_cancer_paper_50pcnt_overlap_extended_normalized_ref.bed
